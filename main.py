...
from app.models.student import Student  # noqa: F401 — ensures table is registered
from app.models.student_history import StudentHistory  # noqa: F401 — ensures table is registered
